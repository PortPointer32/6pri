...
# СООБЩЕНИЯ ОТ БОТА
start_message = """<b>Вас приветствует магазин</b>- priyateI.biz\n\n<b>наши контакты:</b>\nЕсли бот не выдал вам заказ после оплаты, то попробуйте\n получить его на странице priyateI.biz/check\nпо номеру заказа и комментарию. (Через ВПН)\n\nTelegram: @qazz_aaa\nСайт автопродаж - https://priyateI.biz\n\nУдачных покупок!
➖➖➖➖
Привет, <b>%s</b>
Ваш баланс: 💰0 руб.
➖➖➖➖
...
🏃 Автор: 5********4
🏢 Город: Саратов
🍕 Товар: Mefedron VHQ Crystal 1.5 г 
📆 Дата: %s
📊 Оценка: ⭐️⭐️⭐️⭐️⭐️
...
start_3_message = """<b>Вас приветствует магазин - SKYNET
Работай в SKYNET на лучших условиях!
